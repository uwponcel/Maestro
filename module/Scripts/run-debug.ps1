...
Set-Location "C:\git\perso\Maestro\module"
...
if ($LocalBlishHUD) {
    ...
    $process = Start-Process "Blish HUD.exe" -ArgumentList '--debug', '--module', 'C:\git\perso\Maestro\module\bin\x64\Debug\Maestro.bhm' -PassThru
} else {
...
Set-Location "C:\git\perso\Maestro\module\Scripts"
